##末影祭坛
execute as @a[scores={magicpoint=20..}] at @s if block ~~-0.1~ dec:end_altar 0 run tag @s add tp
...
##流动块一级
execute as @a[scores={magicpoint=..40}] at @s if block ~ ~-0.1 ~ dec:flowing_block_1 0 run tag @s add flowing_block_1
execute as @a[scores={magicpoint=..40}] at @s if block ~ ~-0.1 ~ dec:flowing_block_1 0 run setblock ~~-0.1 ~ dec:flowing_block_0
scoreboard players add @a[tag=flowing_block_1] magicpoint 20
...
##流动块二级
execute as @a[scores={magicpoint=..35}] at @s if block ~ ~-0.1 ~ dec:flowing_block_2 0 run tag @s add flowing_block_2
execute as @a[scores={magicpoint=..35}] at @s if block ~ ~-0.1 ~ dec:flowing_block_2 0 run setblock ~~-0.1 ~ dec:flowing_block_0
...
##流动块三级
execute as @a[scores={magicpoint=..25}] at @s if block ~ ~-0.1 ~ dec:flowing_block_3 0 run tag @s add flowing_block_3
execute as @a[scores={magicpoint=..25}] at @s if block ~ ~-0.1 ~ dec:flowing_block_3 0 run setblock ~~-0.1 ~ dec:flowing_block_0
scoreboard players add @a[tag=flowing_block_3] magicpoint 35
...
##流动块四级
execute as @a[scores={magicpoint=..10}] at @s if block ~ ~-0.1 ~ dec:flowing_block_4 0 run tag @s add flowing_block_4
execute as @a[scores={magicpoint=..10}] at @s if block ~ ~-0.1 ~ dec:flowing_block_4 0 run setblock ~~-0.1 ~ dec:flowing_block_0
scoreboard players add @a[tag=flowing_block_4] magicpoint 50
...
execute at @e[scores={magicpoint=1..}] as @s if block ~~-0.1~ dec:radiate_dirt 0 run scoreboard players remove @s magicpoint 1
...
execute at @e[scores={magicpoint=1..}] as @s if block ~~-0.1~ dec:radiate_stone 0 run scoreboard players remove @s magicpoint 1
...
execute at @e[scores={magicpoint=1..}] as @s if block ~~-0.1~ dec:radiate_stonebrick 0 run scoreboard players remove @s magicpoint 1