...
##流动块一级
execute as @a[scores={magicpoint=..40}] at @s if block ~ ~-0.1 ~ dec:flowing_block_1 [] run tag @s add flowing_block_1
execute as @a[scores={magicpoint=..40}] at @s if block ~ ~-0.1 ~ dec:flowing_block_1 [] run setblock ~~-0.1 ~ dec:flowing_block_0
...
##流动块二级
execute as @a[scores={magicpoint=..35}] at @s if block ~ ~-0.1 ~ dec:flowing_block_2 [] run tag @s add flowing_block_2
execute as @a[scores={magicpoint=..35}] at @s if block ~ ~-0.1 ~ dec:flowing_block_2 [] run setblock ~~-0.1 ~ dec:flowing_block_0
...
##流动块三级
execute as @a[scores={magicpoint=..25}] at @s if block ~ ~-0.1 ~ dec:flowing_block_3 [] run tag @s add flowing_block_3
execute as @a[scores={magicpoint=..25}] at @s if block ~ ~-0.1 ~ dec:flowing_block_3 [] run setblock ~~-0.1 ~ dec:flowing_block_0
...
##流动块四级
execute as @a[scores={magicpoint=..10}] at @s if block ~ ~-0.1 ~ dec:flowing_block_4 [] run tag @s add flowing_block_4
execute as @a[scores={magicpoint=..10}] at @s if block ~ ~-0.1 ~ dec:flowing_block_4 [] run setblock ~~-0.1 ~ dec:flowing_block_0
