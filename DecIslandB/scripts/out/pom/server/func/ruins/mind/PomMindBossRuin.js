...
export default class PomMindBossRuin {
    constructor(seed) {
        this.structure_area1 = "mystructure:boss_mind_area_b1";
        this.structure_area2 = "mystructure:boss_mind_area_b2";
        this.structure_area3 = "mystructure:boss_mind_area_b3";
        this.structure_area4 = "mystructure:boss_mind_area_b4";
        this._pathArea = [];
        this._monsterArea = [];
        this._playerArea = [];
        this.seed = seed;
    ...
    init(x, y, z, dim) {
        ...
        this._bossArea = (new ExBlockArea(new Vector3(62, 36, 62).add(x, y, z), new Vector3(4, 6, 4)));
        this._playerArea.push(new ExBlockArea(new Vector3(36, 37, 36).add(x, y, z), new Vector3(50, 4, 50)));
    }
    generate() {
