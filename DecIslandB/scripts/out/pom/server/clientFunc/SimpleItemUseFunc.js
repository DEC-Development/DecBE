...
export default class SimpleItemUseFunc extends GameController {
    ...
    onJoin() {
        ...
        this.getEvents().exEvents.afterPlayerHitEntity.subscribe(e => {
            var _a;
            if (e.damageSource.cause === EntityDamageCause.entityAttack && ((_a = this.exPlayer.getBag().itemOnMainHand) === null || _a === void 0 ? void 0 : _a.typeId) === "wb:sword_intentions") {
                new ExEntityQuery(this.getDimension()).at(this.player.location)
                ...
                this.getDimension().spawnParticle("wb:intension_sweep_a", new ExEntityQuery(this.getDimension()).at(this.player.location)
                    .facingByLTF(new Vector3(0, 1, 3), this.player.getViewDirection()).position, map);
            }
        });
        this.getEvents().exEvents.tick.subscribe(e => {
            var _a, _b;
            if (((_a = this.exPlayer.getBag().itemOnMainHand) === null || _a === void 0 ? void 0 : _a.typeId) === "wb:sword_ink_g" && !this.inkSwordsSkill) {
                (_b = this.player.getComponent("minecraft:movement")) === null || _b === void 0 ? void 0 : _b.setCurrentValue(MathUtil.clamp(0.48 * (new Vector3(this.player.getVelocity()).len()), 0.1, 0.7));
            }
        });
        this.getEvents().exEvents.beforeItemUse.subscribe(e => {
            var _a;
