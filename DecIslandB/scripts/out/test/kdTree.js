...
console.log(`Nearest Neighbor of (${queryPointForNN.coordinates.join(", ")}) is (${nearestNeighbor === null || nearestNeighbor === void 0 ? void 0 : nearestNeighbor.coordinates.join(", ")}).`);
// Test 5: Range Search
