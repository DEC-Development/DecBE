...
export default class PomGuardBossRuin {
    constructor(seed) {
        this.structure_area1 = "mystructure:boss_guard_area_b1";
        this.structure_area2 = "mystructure:boss_guard_area_b3";
        this.structure_area3 = "mystructure:boss_guard_area_b2";
        this.structure_area4 = "mystructure:boss_guard_area_b4";
        this._pathArea = [];
        this._monsterArea = [];
        this._playerArea = [];
        this.seed = seed;
    ...
    init(x, y, z, dim) {
        ...
        this._playerArea.push(new ExBlockArea(new Vector3(3, 5, 3).add(x, y, z), new Vector3(1, 1, 1)), new ExBlockArea(new Vector3(128 - 3 - 1, 5, 3).add(x, y, z), new Vector3(1, 1, 1)), new ExBlockArea(new Vector3(3, 5, 128 - 3 - 1).add(x, y, z), new Vector3(1, 1, 1)), new ExBlockArea(new Vector3(128 - 3 - 1, 5, 128 - 3 - 1).add(x, y, z), new Vector3(1, 1, 1)));
    }
    generate() {
...
//# sourceMappingURL=PomGuardBossRuin.js.map