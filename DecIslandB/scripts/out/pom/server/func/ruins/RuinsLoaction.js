...
RuinsLoaction.ANCIENT_RUIN_LOCATION_END = _a.ANCIENT_RUIN_LOCATION_START.clone().add(_a.ANCIENT_RUIN_LOCATION_SIZE);
RuinsLoaction.ANCIENT_RUIN_LOCATION_CENTER = _a.ANCIENT_RUIN_LOCATION_START.clone().add(_a.ANCIENT_RUIN_LOCATION_SIZE.x / 2, 0, _a.ANCIENT_RUIN_LOCATION_SIZE.z / 2);
RuinsLoaction.ANCIENT_RUIN_AREA = new ExBlockArea(_a.ANCIENT_RUIN_LOCATION_START, _a.ANCIENT_RUIN_LOCATION_SIZE);
RuinsLoaction.ANCIENT_RUIN_PROTECT_AREA = new ExBlockArea(_a.ANCIENT_RUIN_LOCATION_START.clone().sub(_a.ANCIENT_RUIN_LOCATION_SIZE), _a.ANCIENT_RUIN_LOCATION_END.clone().add(_a.ANCIENT_RUIN_LOCATION_SIZE));
...
RuinsLoaction.MIND_RUIN_LOCATION_END = _a.MIND_RUIN_LOCATION_START.clone().add(_a.MIND_RUIN_LOCATION_SIZE);
RuinsLoaction.MIND_RUIN_LOCATION_CENTER = _a.MIND_RUIN_LOCATION_START.clone().add(_a.MIND_RUIN_LOCATION_SIZE.x / 2, 0, _a.MIND_RUIN_LOCATION_SIZE.z / 2);
RuinsLoaction.MIND_RUIN_AREA = new ExBlockArea(_a.MIND_RUIN_LOCATION_START, _a.MIND_RUIN_LOCATION_SIZE);
RuinsLoaction.MIND_RUIN_PROTECT_AREA = new ExBlockArea(_a.MIND_RUIN_LOCATION_START.clone().sub(_a.MIND_RUIN_LOCATION_SIZE), _a.MIND_RUIN_LOCATION_END.clone().add(_a.MIND_RUIN_LOCATION_SIZE));
